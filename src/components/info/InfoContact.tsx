...
export default function InfoContact() {
  return (
    <div className="font-times-now-semi-light flex flex-col items-center gap-[0.45em] text-center text-[clamp(17px,2.15vw,21px)] leading-[1.45] tracking-[-0.012em] text-black">
